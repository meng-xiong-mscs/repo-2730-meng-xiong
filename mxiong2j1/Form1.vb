...
' Programmer:   Meng Xiong on 11/04/2017
...
Public Class Form1
    ...
    Private Sub btnProper_Click(sender As Object, e As EventArgs) Handles btnProper.Click
        ...
        strName.Substring(0, 1).ToUpper()
        strName = strName.Remove(0, 1)
        strName = strName.Insert(0, strFirstChar)

        If strName <> strFirstChar Then
            lblName.Text = StrConv(strName, VbStrConv.ProperCase)
        End If
    End Sub
